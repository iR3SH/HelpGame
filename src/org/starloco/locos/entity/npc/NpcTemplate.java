...
public class NpcTemplate {
    ...
    public ArrayList<Couple<Integer,Integer>> verifItemGet(ArrayList<Couple<Integer,Integer>> objects) {
        ...
        for(Couple<ArrayList<Couple<Integer, Integer>>, ArrayList<Couple<Integer, Integer>>> entry0 : this.exchanges) {
            ...
            for(Couple<Integer, Integer> entry1 : entry0.first) {
                ...
                for(Couple<Integer, Integer> entry2 : objects) {
                    if (String.valueOf(entry1.first).equals(String.valueOf(World.world.getGameObject(entry2.first).getTemplate().getId())) && String.valueOf(entry1.second).equals(String.valueOf(entry2.second)))
                        ok2 = true;
                    if (!ok2) ok1 = false;
                    else break;
                }
            ...
            if(ok1 && objects.size() == entry0.first.size()) return entry0.second;
        }
        return null;
    }
}
