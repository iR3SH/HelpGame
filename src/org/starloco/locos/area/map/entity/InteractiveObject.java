...
public class InteractiveObject {
            ...
            case 542://Statue Phoenix.
                if (player.isGhost()) {
                    ...
                    if (q != null) {
                        ...
                        if (qp != null) {
                            Quest_Etape qe = q.getQuestEtapeCurrent(qp);
                            if (qe != null)
                                if(qe.getId() == 783)
        ...
        switch (perso.getCurMap().getId()) {
            case 7460:
                ...
                for (int v = 0; v < q.length; v++) {
                    if (Integer.parseInt(q[v][1]) == cell
                            && Integer.parseInt(q[v][0]) == id) {
    ...
    public static class InteractiveObjectTemplate {
        ...
        public InteractiveObjectTemplate(int id, int respawnTime, int duration,
                                         int unk, boolean walkable) {
            this.id = id;
