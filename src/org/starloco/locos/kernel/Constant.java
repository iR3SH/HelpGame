...
public class Constant {
 ...
 //   public static final int STATS_ADD_DOMA2 = 1210;
    ...
    public static int[] EXCEPTION_GLADIATROOL_BOSS = {251,295,404,423,450,1017,1018,1159};
    public static int[] EXCEPTION_GLADIATROOL_ARCHI = {251,404,423,450,1017,1018,1159};
    public static int[] EXCEPTION_GLADIATROOL_MONSTRES = {258,260,251,404,424,450,1017,1018,1090,1091,1092,1094};
