...
public class Constant {
 ...
 //   public static final int STATS_ADD_DOMA2 = 1210;
    ...
    public static List<Integer> BOSS_ID = Arrays.asList(58,85,86,107,113,121,147,173,180,225,226,230,232,251,252,257,289,295,374,375,377,382,404,423,430,457,478,568,605,612,669,670,673,675,677,681,780,792,797,799,800,827,854,926,939,940,943,1015,1027,1045,1051,1071,1072,1085,1086,1087,1159,1170,1184,1185,1186,1187,1188,1195);
    public static int[] EXCEPTION_GLADIATROOL_MONSTRES = {251,258,260,295,404,423,424,450,521,557,558,559,560,561,1016,1017,1018,1113,1090,1091,1092,1094,1159,2680,2685};
    ...
    public static String getStatStringbyPalier(Player player,int palier) {
        if(player.getClasse() == CLASS_SACRIEUR){
            ...
            switch (palier - 1) {
                ...
                case 9:
                    return "7d#3e8#0#0#0d0+1000,7c#32#0#0#0d0+50,76#32#0#0#0d0+50,7e#32#0#0#0d0+50,7b#32#0#0#0d0+50,77#32#0#0#0d0+50,70#3#0#0#0d0+3,8a#1e#0#0#0d0+30,b2#5#0#0#0d0+5,73#3#0#0#0d0+3,d6#1#0#0#0d0+1,d2#1#0#0#0d0+1,d5#1#0#0#0d0+1,d3#1#0#0#0d0+1,d4#1#0#0#0d0+1,6f#1#0#0#0d0+1,7d8#64#0#0#0d0+100";
            }
        }
        return "";
    }
