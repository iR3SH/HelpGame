...
public class Constant {
 ...
 //   public static final int STATS_ADD_DOMA2 = 1210;
    ...
    public static final List<Integer> DAMAGE_EFFECT = Arrays.asList(91,92,93,94,95,96,97,98,99,100);
    ...
    public static String getStatStringbyPalier(Player player,int palier) {
        if(player.getClasse() == CLASS_SACRIEUR){
            switch (palier) {
                ...
                case 5:
                    return "7d#190#0#0#0d0+400,7c#32#0#0#0d0+50,76#28#0#0#0d0+40,7e#28#0#0#0d0+40,7b#28#0#0#0d0+40,77#28#0#0#0d0+40,70#3#0#0#0d0+3,8a#1e#0#0#0d0+30,b2#5#0#0#0d0+5,73#3#0#0#0d0+3,d6#5#0#0#0d0+5,d2#5#0#0#0d0+5,d5#5#0#0#0d0+5,d3#5#0#0#0d0+5,d4#5#0#0#0d0+5,6f#1#0#0#0d0+1,80#2#0#0#0d0+2,b6#1#0#0#0d0+1";
                case 7:
                    return "7d#190#0#0#0d0+400,7c#32#0#0#0d0+50,76#28#0#0#0d0+40,7e#28#0#0#0d0+40,7b#28#0#0#0d0+40,77#28#0#0#0d0+40,70#3#0#0#0d0+3,8a#1e#0#0#0d0+30,b2#5#0#0#0d0+5,73#3#0#0#0d0+3,d6#5#0#0#0d0+5,d2#5#0#0#0d0+5,d5#5#0#0#0d0+5,d3#5#0#0#0d0+5,d4#5#0#0#0d0+5,6f#1#0#0#0d0+1,80#2#0#0#0d0+2,b6#1#0#0#0d0+1,75#1#0#0#0d0+1";
                case 9:
            ...
            switch (palier) {
                ...
                case 5:
                    return "7d#fa#0#0#0d0+250,7c#32#0#0#0d0+50,76#32#0#0#0d0+50,7e#32#0#0#0d0+50,7b#32#0#0#0d0+50,77#32#0#0#0d0+50,70#3#0#0#0d0+3,8a#1e#0#0#0d0+30,b2#5#0#0#0d0+5,73#3#0#0#0d0+3,d6#5#0#0#0d0+5,d2#5#0#0#0d0+5,d5#5#0#0#0d0+5,d3#5#0#0#0d0+5,d4#5#0#0#0d0+5,6f#1#0#0#0d0+1,80#2#0#0#0d0+2,b6#1#0#0#0d0+1";
                case 7:
