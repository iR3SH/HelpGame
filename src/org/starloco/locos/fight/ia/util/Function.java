...
public class Function {
    ...
    public static boolean testCotes(int cellWeAre, int cellWego)//Nous permet d'interdire le déplacement du bord vers des cellules hors map
    {
        ...
        if (cellWeAre >= 16 && cellWeAre <= 27) {
            return cellWego != cellWeAre - 15 && cellWego != cellWeAre - 14;
        }
        return true;
    }
    ...
    public boolean checkIfInvocPossible(Fight fight, Fighter fighter, List<SortStats> Spelllist) {
        ...
        if (spell == null)
            return false;
        return fighter.nbInvocation() < fighter.getTotalStats().getEffect(Constant.STATS_ADD_SUM);
    }
    ...
    public String moveToBuffIfPossible(Fight fight, Fighter fighter, ArrayList<SortStats> sorts) {
        try {
            if (fight == null || fighter == null)
                return "";
            GameMap m = fight.getMap();
            ...
            int distMin = PathFinding.getDistanceBetween(m, _c.getId(), friend.getCell().getId());
    ...
    public String getBestTargetZone(Fight fight, Fighter fighter, SortStats spell, int launchCell, boolean line) {
        ...
        if (spell.getMaxPO() != 0) {
            ...
            String args = String.valueOf(arg1) + arg2;
