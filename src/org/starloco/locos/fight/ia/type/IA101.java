	  ...
	  if(!this.stop&&this.fighter.canPlay()&&this.count>0)
	    {
	      ...
	      Fighter A=Function.getInstance().getNearestAminoinvocnbrcasemax(this.fight,this.fighter,0,4);// pomax +1; 3 PO +1 car trop relou sinon avec déplacement puis boost amplification
	      if(C!=null&&C.isHide())
	        C=null;
	      ...
	      {
	    	// Idéalement ne devrait pas chercher à détacler pour boost si est au cac
