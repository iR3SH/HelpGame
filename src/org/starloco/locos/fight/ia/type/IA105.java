...
public class IA105 extends AbstractNeedSpell
{
  private byte move=0;

  public IA105(Fight fight, Fighter fighter, byte count)
  {
  ...
  public void apply()
  {
    if(!this.stop&&this.fighter.canPlay()&&this.count>0)
    {
      ...
      Fighter A=Function.getInstance().getNearestAminoinvocnbrcasemax(this.fight,this.fighter,0,maxPo+1);// pomax +1;
